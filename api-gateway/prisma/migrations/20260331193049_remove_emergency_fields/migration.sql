/*
  ...
  - You are about to drop the column `emergency_contact_relation` on the `User` table. All the data in the column will be lost.
...
CREATE TABLE "new_User" (
    ...
    "digilocker_refresh_token" TEXT,
    "digilocker_token_expires_at" DATETIME,
    "digilocker_state" TEXT,
    "digilocker_state_expires_at" DATETIME,
...
INSERT INTO "new_User" ("aadhaar_hash", "abha_id", "address_line", "biometric_status", "city", "created_at", "date_of_birth", "digilocker_access_token", "digilocker_linked", "digilocker_refresh_token", "digilocker_state", "digilocker_state_expires_at", "digilocker_token_expires_at", "display_name", "email", "full_name", "id", "password_hash", "pending_requests", "phone", "prism_id", "profile_photo_url", "security_tier", "state", "trust_score", "updated_at") SELECT "aadhaar_hash", "abha_id", "address_line", "biometric_status", "city", "created_at", "date_of_birth", "digilocker_access_token", "digilocker_linked", "digilocker_refresh_token", "digilocker_state", "digilocker_state_expires_at", "digilocker_token_expires_at", "display_name", "email", "full_name", "id", "password_hash", "pending_requests", "phone", "prism_id", "profile_photo_url", "security_tier", "state", "trust_score", "updated_at" FROM "User";
DROP TABLE "User";
